  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-start justify-between gap-6">
        ...
        {/* Voice Bot Panel - external link to deployed bot for voice registration in multiple languages */}
        <Card className="max-w-sm w-full">
          <CardHeader>
            <CardTitle className="text-sm">Speak with Voice Bot</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-3">Use the municipal voice bot to speak in English, हिंदी, or తెలుగు and register a complaint by phone.</p>
            <a
              href="https://maharashtra-ai-bot-140508788178.us-west1.run.app/"
              target="_blank"
              rel="noreferrer"
